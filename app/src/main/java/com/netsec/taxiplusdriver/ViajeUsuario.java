...
public class ViajeUsuario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ViajeUsuario.this, MapsFuncDriver.class);
    ...
    public void enviarRespuestaViaje()
    {
        ...
        StringRequest request = new StringRequest(Request.Method.POST,  SERVIDOR_CONTROLADOR+"respuesta_viaje_usuario.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response.equals("ocupado")){
                            ...
                            editorViaje.putString("id_usuario"," ");
                            editorViaje.putString("tipo_viaje"," ");
                            editorViaje.putString("lat_inicio"," ");
                            editorViaje.putString("lng_inicio"," ");
                            editorViaje.putString("lat_final"," ");
                            editorViaje.putString("lng_final"," ");
                            editorViaje.putString("costo"," ");
                            editorViaje.putString("estado"," ");
                            editorViaje.apply();
                        }
                        if (response.equals("success")){
                            editorViaje.putString("estado","destino_usuario");
                            editorViaje.apply();
                            Intent intent = new Intent(ViajeUsuario.this, MapsFuncDriver.class);
                            startActivity(intent);
                        }
